package com.mobile.test.galagaattack;
...
public class iSound {
    ...
    private String[] musicIDs = new String[3];
...
//Load sound using the asset file descriptor
            AssetFileDescriptor afd = ctx.getAssets().openFd("missleSound.mp3");
//store the id outputted by the sound pool in the sound effects array
            ...
            afd = ctx.getAssets().openFd("laserSound.wav");
            soundIDs[1] = sounds.load(afd.getFileDescriptor(), afd.getStartOffset(), afd.getLength(), 0);
            afd = ctx.getAssets().openFd("ExplosionSound.wav");
        ...
        musicIDs[0] = "MainMenuBackgroundMusic.mp3";
        musicIDs[1] = "GameMusic.wav";
        musicIDs[2] = "GameOverMusic.mp3";
